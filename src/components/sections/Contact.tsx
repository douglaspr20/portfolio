...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="from-muted/20 to-background relative bg-gradient-to-b py-12"
    >
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="space-y-8">
              ...
              <p className="mb-8 text-gray-700 dark:text-gray-300">
                I'm available for new projects and collaborations. Don't
                hesitate to reach out to discuss your ideas.
              </p>
              ...
              <div className="space-y-6">
                {contactsMethods.map((method) => (
                  <Card
                    key={method.title}
                    className="group flex cursor-pointer items-center space-x-4 bg-gradient-to-r p-4 transition-colors group-hover:scale-110 hover:brightness-90 dark:border-transparent dark:from-slate-950 dark:to-slate-800 dark:shadow-slate-600 dark:hover:brightness-125"
                  >
                    <div
